...
class laporan_pesanan extends CI_Controller {
	 ...
	 * @see https://codeigniter.com/laporan_laporan_pesanan_guide/general/urls.html
	 */
	...
	{
        $header['page'] = 'laporan_pesanan';
        $header['name_page'] = 'Laporan Pesanan';
	...
	public function cetak()
	{
		...
		$this->load->view('cetak_laporan_pesanan', $data);
	}
}

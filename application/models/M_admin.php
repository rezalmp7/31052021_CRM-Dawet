...
class M_admin extends CI_Model
{
    ...
    function select_select_join_2table_wherebeetween2($select, $table, $table2, $on2, $where, $dateFirst, $dateSecond)
    {
        return $this->db->query("SELECT ".$select." FROM ".$table." LEFT JOIN ".$table2." ON ".$on2." where ".$where." between '".$dateFirst." 00:00:00' and '".$dateSecond." 23:59:59'");
    }
